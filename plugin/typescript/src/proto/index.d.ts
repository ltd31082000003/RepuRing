...
export namespace types {
    ...
    /** Represents a MessageLeaveCircle. */
    class MessageLeaveCircle implements IMessageLeaveCircle {

        /**
         * Constructs a new MessageLeaveCircle.
         * @param [properties] Properties to set
         */
        constructor(properties?: types.IMessageLeaveCircle);
         ...
         * @param [properties] Properties to set
         * @returns MessageLeaveCircle instance
         */
        public static create(properties?: types.IMessageLeaveCircle): types.MessageLeaveCircle;
         ...
         * @param message MessageLeaveCircle message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: types.IMessageLeaveCircle, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: types.IMessageLeaveCircle, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes a MessageLeaveCircle message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns MessageLeaveCircle
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): types.MessageLeaveCircle;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): types.MessageLeaveCircle;
         ...
         * @returns MessageLeaveCircle
         */
        public static fromObject(object: { [k: string]: any }): types.MessageLeaveCircle;

        /**
         * Creates a plain object from a MessageLeaveCircle message. Also converts values to other types if specified.
         * @param message MessageLeaveCircle
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: types.MessageLeaveCircle, options?: $protobuf.IConversionOptions): { [k: string]: any };
